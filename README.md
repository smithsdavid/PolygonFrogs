...
Developers at Polygon Labs have been hard at work gathering and incorporating community feedback into the Frog client, v0.8, is here with several new features! Check out the Release Notes included with the release to find out more! 

## Polygon Frogs

Polygon Frogs is a modular and extensible framework for building Ethereum-compatible blockchain networks.
...
Copyright 2022 Polygon Frogs Technology
